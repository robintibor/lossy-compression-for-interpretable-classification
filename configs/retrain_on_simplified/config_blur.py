...
def get_grid_param_list():
    ...
    save_params = [
        {
            "save_folder": "/work/dlclarge2/schirrmr-lossy-compression/exps/rebuttal/retrain-blur/",
    ...
    blur_params = dictlistprod({
        'blur_sigma': np.linspace(2.3,4.0,18),#np.linspace(1.6,2.2,7),#np.linspace(1.2,1.5,14),#np.linspace(0.2,1.5,14),
        'blur_simplifier': [True],
        'dataset': ['mnist', ],#'svhn','cifar10', #'fashionmnist'
    })

...
def get_grid_param_list():
    ...
    save_params = [
        {
        'save_folder': '/home/schirrmr/data/exps/invertible-neurips/joint-first/',
    },
    ]
    ...
    model_params = dictlistprod({
        'saved_model_path': ['/home/schirrmr/data/exps/invertible/pretrain/57/10_model.neurips.th'],#'/home/rsc7rng/exps/pretrain/14/125_model.th'
        'saved_optimizer_path': [None],
        #'/home/schirrmr/data/exps/invertible/pretrain/57/state_dicts_optimizer_10.pth'
        'reinit': [False,],
        'K': [32],
